...
(function () {
  // #region agent log
  fetch('http://127.0.0.1:7495/ingest/318d51cb-b399-4a23-8524-822d500521db',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'7080a9'},body:JSON.stringify({sessionId:'7080a9',location:'matchifyData.js:5',message:'matchifyData IIFE start',data:{hasMatchifyData:typeof window.MatchifyData!=='undefined'},timestamp:Date.now(),hypothesisId:'B'})}).catch(()=>{});
  // #endregion
  const STORAGE = {
    users: "matchifyUsers",
  ...
  // #region agent log
  fetch('http://127.0.0.1:7495/ingest/318d51cb-b399-4a23-8524-822d500521db',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'7080a9'},body:JSON.stringify({sessionId:'7080a9',location:'matchifyData.js:583',message:'assigning window.MatchifyData',data:{storageKeys:Object.keys(STORAGE)},timestamp:Date.now(),hypothesisId:'B'})}).catch(()=>{});
  // #endregion
  window.MatchifyData = {
    STORAGE,
    init,
