...
const synonymGroups = [
  ...
  ["ux designer", "ui designer", "product designer", "ux/ui designer", "ux", "interaction designer"],
  ["devops", "site reliability engineer", "sre", "platform engineer", "infrastructure engineer"],
  ["qa", "tester", "quality assurance", "test engineer", "sdet", "automation tester"],
  ...
  ["mobile developer", "mobile engineer", "ios developer", "android developer", "app developer"],
  ["cloud engineer", "cloud architect", "cloud developer", "solutions architect"],
  ["security engineer", "cybersecurity", "infosec", "security analyst", "penetration tester"],
  ["database administrator", "database engineer", "dba"],
  ["network engineer", "network administrator", "system administrator", "sysadmin"],
  ["technical writer", "documentation engineer", "content strategist"],
  ["marketing manager", "digital marketing", "growth marketing", "seo specialist", "content marketing"],
  ...
  ["financial analyst", "accountant", "finance manager", "financial controller"],
  ["intern", "internship", "graduate program", "entry level", "junior"],
  ...
  ["golang", "go language"],
  ["ruby", "ruby on rails", "rails developer"],
  ["php", "laravel", "wordpress developer"],
  ["swift", "swiftui", "ios engineer"],
  ["kotlin", "android engineer", "jetpack compose"],
  ...
  ["biomedical engineer", "medical device engineer", "health tech"],
  ["research scientist", "r&d engineer", "lab technician"],
  ["legal counsel", "lawyer", "corporate attorney"],
  ["executive assistant", "office administrator", "administrative assistant"]
];
